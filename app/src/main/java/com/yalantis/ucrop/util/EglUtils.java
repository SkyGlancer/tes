...
public class EglUtils {
    ...
    private static int getMaxTextureEgl14() {
        ...
        int[] arrn = new int[2];
        EGL14.eglInitialize((EGLDisplay)eGLDisplay, (int[])arrn, (int)0, (int[])arrn, (int)1);
        int[] arrn2 = new int[]{12351, 12430, 12329, 0, 12352, 4, 12339, 1, 12344};
        EGLConfig[] arreGLConfig = new EGLConfig[1];
        int[] arrn3 = new int[1];
        EGL14.eglChooseConfig((EGLDisplay)eGLDisplay, (int[])arrn2, (int)0, (EGLConfig[])arreGLConfig, (int)0, (int)1, (int[])arrn3, (int)0);
        if (arrn3[0] == 0) {
            return 0;
        }
        EGLConfig eGLConfig = arreGLConfig[0];
        android.opengl.EGLSurface eGLSurface = EGL14.eglCreatePbufferSurface((EGLDisplay)eGLDisplay, (EGLConfig)eGLConfig, (int[])new int[]{12375, 64, 12374, 64, 12344}, (int)0);
        int[] arrn4 = new int[]{12440, 2, 12344};
        EGLContext eGLContext = EGL14.eglCreateContext((EGLDisplay)eGLDisplay, (EGLConfig)eGLConfig, (EGLContext)EGL14.EGL_NO_CONTEXT, (int[])arrn4, (int)0);
        EGL14.eglMakeCurrent((EGLDisplay)eGLDisplay, (android.opengl.EGLSurface)eGLSurface, (android.opengl.EGLSurface)eGLSurface, (EGLContext)eGLContext);
        int[] arrn5 = new int[1];
        ...
        EGL14.eglDestroySurface((EGLDisplay)eGLDisplay, (android.opengl.EGLSurface)eGLSurface);
