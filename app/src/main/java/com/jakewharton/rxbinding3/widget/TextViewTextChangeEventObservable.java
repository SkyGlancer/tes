...
extends InitialValueObservable<TextViewTextChangeEvent> {
    ...
    protected TextViewTextChangeEvent getInitialValue() {
        ...
        TextViewTextChangeEvent textViewTextChangeEvent = new TextViewTextChangeEvent(textView, charSequence, 0, 0, 0);
    ...
    implements TextWatcher {
        ...
        public void onTextChanged(CharSequence charSequence, int n, int n2, int n3) {
            Intrinsics.checkParameterIsNotNull((Object)charSequence, (String)"s");
            if (!this.isDisposed()) {
                Observer<? super TextViewTextChangeEvent> observer = this.observer;
                TextViewTextChangeEvent textViewTextChangeEvent = new TextViewTextChangeEvent(this.view, charSequence, n, n2, n3);
                observer.onNext((Object)textViewTextChangeEvent);
            }
        }
    }
