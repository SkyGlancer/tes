...
extends Observable<TextViewEditorActionEvent> {
    ...
    public TextViewEditorActionEventObservable(TextView textView, Function1<? super TextViewEditorActionEvent, Boolean> function1) {
    ...
    implements TextView.OnEditorActionListener {
        ...
        public Listener(TextView textView, Observer<? super TextViewEditorActionEvent> observer, Function1<? super TextViewEditorActionEvent, Boolean> function1) {
            Intrinsics.checkParameterIsNotNull((Object)textView, (String)"view");
            Intrinsics.checkParameterIsNotNull(observer, (String)"observer");
            Intrinsics.checkParameterIsNotNull(function1, (String)"handled");
            this.view = textView;
        ...
        public boolean onEditorAction(TextView textView, int n, KeyEvent keyEvent) {
            ...
            TextViewEditorActionEvent textViewEditorActionEvent = new TextViewEditorActionEvent(this.view, n, keyEvent);
            try {
                if (!this.isDisposed() && ((Boolean)this.handled.invoke((Object)textViewEditorActionEvent)).booleanValue()) {
                    this.observer.onNext((Object)textViewEditorActionEvent);
                    return true;
                }
            }
