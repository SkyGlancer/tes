...
import com.jakewharton.rxbinding3.widget.AdapterViewSelectionObservable;
...
final class RxAdapterView__AdapterViewSelectionObservableKt {
    public static final <T extends Adapter> InitialValueObservable<AdapterViewSelectionEvent> selectionEvents(AdapterView<T> adapterView) {
        Intrinsics.checkParameterIsNotNull(adapterView, (String)"$this$selectionEvents");
        return (InitialValueObservable)new AdapterViewSelectionObservable(adapterView);
    }
}
