...
import com.jakewharton.rxbinding3.widget.AbsListViewScrollEventObservable;
...
final class RxAbsListView__AbsListViewScrollEventObservableKt {
    public static final Observable<AbsListViewScrollEvent> scrollEvents(AbsListView absListView) {
        Intrinsics.checkParameterIsNotNull((Object)absListView, (String)"$this$scrollEvents");
