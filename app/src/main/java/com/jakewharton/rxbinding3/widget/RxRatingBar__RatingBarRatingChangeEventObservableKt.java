...
import com.jakewharton.rxbinding3.widget.RatingBarRatingChangeEventObservable;
...
final class RxRatingBar__RatingBarRatingChangeEventObservableKt {
    public static final InitialValueObservable<RatingBarChangeEvent> ratingChangeEvents(RatingBar ratingBar) {
        Intrinsics.checkParameterIsNotNull((Object)ratingBar, (String)"$this$ratingChangeEvents");
        return (InitialValueObservable)new RatingBarRatingChangeEventObservable(ratingBar);
    }
}
