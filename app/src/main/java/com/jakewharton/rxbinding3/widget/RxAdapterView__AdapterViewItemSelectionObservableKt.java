...
import com.jakewharton.rxbinding3.widget.AdapterViewItemSelectionObservable;
...
final class RxAdapterView__AdapterViewItemSelectionObservableKt {
    public static final <T extends Adapter> InitialValueObservable<Integer> itemSelections(AdapterView<T> adapterView) {
        Intrinsics.checkParameterIsNotNull(adapterView, (String)"$this$itemSelections");
        return (InitialValueObservable)new AdapterViewItemSelectionObservable(adapterView);
    }
}
