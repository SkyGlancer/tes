...
public final class AdapterViewItemClickEvent {
    ...
    public AdapterViewItemClickEvent(AdapterView<?> adapterView, View view, int n, long l) {
    ...
    public static /* synthetic */ AdapterViewItemClickEvent copy$default(AdapterViewItemClickEvent adapterViewItemClickEvent, AdapterView adapterView, View view, int n, long l, int n2, Object object) {
        if ((n2 & 1) != 0) {
        ...
        View view2 = view;
        if ((n2 & 4) != 0) {
            n = adapterViewItemClickEvent.position;
        }
        int n3 = n;
        if ((n2 & 8) != 0) {
            l = adapterViewItemClickEvent.id;
        }
        long l2 = l;
        return adapterViewItemClickEvent.copy(adapterView, view2, n3, l2);
    }
    ...
    public final AdapterViewItemClickEvent copy(AdapterView<?> adapterView, View view, int n, long l) {
        Intrinsics.checkParameterIsNotNull(adapterView, (String)"view");
    ...
    public boolean equals(Object object) {
        if (this != object) {
            if (object instanceof AdapterViewItemClickEvent) {
                boolean bl;
                boolean bl2;
                AdapterViewItemClickEvent adapterViewItemClickEvent = (AdapterViewItemClickEvent)object;
                if (Intrinsics.areEqual(this.view, adapterViewItemClickEvent.view) && Intrinsics.areEqual((Object)this.clickedView, (Object)adapterViewItemClickEvent.clickedView) && (bl = this.position == adapterViewItemClickEvent.position) && (bl2 = this.id == adapterViewItemClickEvent.id)) {
                    return true;
                }
            }
            return false;
    ...
    public String toString() {
        ...
        stringBuilder.append("AdapterViewItemClickEvent(view=");
