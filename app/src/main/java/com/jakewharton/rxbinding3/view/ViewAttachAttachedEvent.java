...
public final class ViewAttachAttachedEvent
extends ViewAttachEvent {
    ...
    public static /* synthetic */ ViewAttachAttachedEvent copy$default(ViewAttachAttachedEvent viewAttachAttachedEvent, View view, int n, Object object) {
        if ((n & 1) != 0) {
    ...
    public boolean equals(Object object) {
        block2 : {
            block3 : {
                ...
                if (!(object instanceof ViewAttachAttachedEvent)) break block3;
                ViewAttachAttachedEvent viewAttachAttachedEvent = (ViewAttachAttachedEvent)object;
                if (Intrinsics.areEqual((Object)this.getView(), (Object)viewAttachAttachedEvent.getView())) break block2;
            }
            return false;
        }
        return true;
    ...
    public String toString() {
        ...
        stringBuilder.append("ViewAttachAttachedEvent(view=");
