...
final class RxView__ViewAttachesObservableKt {
    public static final Observable<Unit> attaches(View view) {
        Intrinsics.checkParameterIsNotNull((Object)view, (String)"$this$attaches");
        return (Observable)new ViewAttachesObservable(view, true);
    }

    public static final Observable<Unit> detaches(View view) {
        Intrinsics.checkParameterIsNotNull((Object)view, (String)"$this$detaches");
