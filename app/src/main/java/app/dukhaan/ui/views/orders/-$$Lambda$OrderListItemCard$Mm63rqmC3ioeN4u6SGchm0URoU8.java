...
public final class -$$Lambda$OrderListItemCard$Mm63rqmC3ioeN4u6SGchm0URoU8
implements IOrderStatusItemClickListener {
    public final /* synthetic */ OrderListItemCard f$0;

    public /* synthetic */ -$$Lambda$OrderListItemCard$Mm63rqmC3ioeN4u6SGchm0URoU8(OrderListItemCard orderListItemCard) {
        this.f$0 = orderListItemCard;
    }

    @Override
    public final void positiveStatus(OrderStatusDialogType orderStatusDialogType) {
        this.f$0.lambda$null$3$OrderListItemCard(orderStatusDialogType);
    }
}
