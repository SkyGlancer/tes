 ...
 *  app.dukhaan.databinding.BtnPrimaryShadowedBinding
...
public class PrimaryButtonShadowed
extends FrameLayout {
    ...
    public PrimaryButtonShadowed(Context context) {
        super(context);
        this.init(context, null, 0);
    }

    public PrimaryButtonShadowed(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        this.init(context, attributeSet, 0);
    }

    public PrimaryButtonShadowed(Context context, AttributeSet attributeSet, int n) {
    ...
    private void init(Context context, AttributeSet attributeSet, int n) {
        this.binding = BtnPrimaryShadowedBinding.inflate((LayoutInflater)((LayoutInflater)context.getSystemService("layout_inflater")), (ViewGroup)this, (boolean)true);
