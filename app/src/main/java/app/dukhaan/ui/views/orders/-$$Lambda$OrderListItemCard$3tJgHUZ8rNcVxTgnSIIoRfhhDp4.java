...
public final class -$$Lambda$OrderListItemCard$3tJgHUZ8rNcVxTgnSIIoRfhhDp4
implements IOrderStatusItemClickListener {
    public final /* synthetic */ OrderListItemCard f$0;

    public /* synthetic */ -$$Lambda$OrderListItemCard$3tJgHUZ8rNcVxTgnSIIoRfhhDp4(OrderListItemCard orderListItemCard) {
        this.f$0 = orderListItemCard;
    }

    @Override
    public final void positiveStatus(OrderStatusDialogType orderStatusDialogType) {
        this.f$0.lambda$null$11$OrderListItemCard(orderStatusDialogType);
    }
}
