 ...
 *  app.dukhaan.databinding.BtnFullShadowedBinding
...
public class FullButtonShadowed
extends FrameLayout {
    ...
    public FullButtonShadowed(Context context) {
        super(context);
        this.init(context, null, 0);
    }

    public FullButtonShadowed(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        this.init(context, attributeSet, 0);
    }

    public FullButtonShadowed(Context context, AttributeSet attributeSet, int n) {
    ...
    private void applyStyle() {
        ...
        if (this.enabled) {
            this.binding.label.setTextColor(ContextCompat.getColor((Context)this.getContext(), (int)2131099691));
            this.binding.label.setBackgroundResource(2131230824);
            return;
        }
        this.binding.label.setTextColor(ContextCompat.getColor((Context)this.getContext(), (int)2131099690));
        this.binding.label.setBackgroundResource(2131230823);
    }

    private void init(Context context, AttributeSet attributeSet, int n) {
        this.binding = BtnFullShadowedBinding.inflate((LayoutInflater)((LayoutInflater)context.getSystemService("layout_inflater")), (ViewGroup)this, (boolean)true);
