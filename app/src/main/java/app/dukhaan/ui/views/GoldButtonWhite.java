 ...
 *  app.dukhaan.databinding.BtnGoldWhiteBinding
...
extends FrameLayout {
    ...
    public GoldButtonWhite(Context context) {
        super(context);
        this.init(context, null, 0);
    }

    public GoldButtonWhite(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        this.init(context, attributeSet, 0);
    }

    public GoldButtonWhite(Context context, AttributeSet attributeSet, int n) {
    ...
    private void applyStyle() {
        ...
        if (this.enabled) {
            this.binding.label.setTextColor(ContextCompat.getColor((Context)this.getContext(), (int)2131099716));
            this.binding.label.setBackgroundResource(2131230828);
            return;
        }
        this.binding.label.setTextColor(ContextCompat.getColor((Context)this.getContext(), (int)2131099716));
        this.binding.label.setBackgroundResource(2131230827);
    }

    private void init(Context context, AttributeSet attributeSet, int n) {
        this.binding = BtnGoldWhiteBinding.inflate((LayoutInflater)((LayoutInflater)context.getSystemService("layout_inflater")), (ViewGroup)this, (boolean)true);
