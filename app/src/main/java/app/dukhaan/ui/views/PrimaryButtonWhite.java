 ...
 *  app.dukhaan.databinding.BtnPrimaryWhiteBinding
...
public class PrimaryButtonWhite
extends FrameLayout {
    private BtnPrimaryWhiteBinding binding;
    private boolean enabled;
    private OnClickListener listener;
    private String text;

    public PrimaryButtonWhite(Context context) {
        super(context);
        this.init(context, null, 0);
    }

    public PrimaryButtonWhite(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        this.init(context, attributeSet, 0);
    }

    public PrimaryButtonWhite(Context context, AttributeSet attributeSet, int n) {
    ...
    private void init(Context context, AttributeSet attributeSet, int n) {
        this.binding = BtnPrimaryWhiteBinding.inflate((LayoutInflater)((LayoutInflater)context.getSystemService("layout_inflater")), (ViewGroup)this, (boolean)true);
