...
public class PrimaryButtonWhite extends FrameLayout {
   private BtnPrimaryWhiteBinding binding;
   private boolean enabled;
   private OnClickListener listener;
   private String text;

   public PrimaryButtonWhite(Context var1) {
      super(var1);
      this.init(var1, (AttributeSet)null, 0);
   }

   public PrimaryButtonWhite(Context var1, AttributeSet var2) {
      super(var1, var2);
      this.init(var1, var2, 0);
   }

   public PrimaryButtonWhite(Context var1, AttributeSet var2, int var3) {
   ...
   private void init(Context var1, AttributeSet var2, int var3) {
      this.binding = BtnPrimaryWhiteBinding.inflate((LayoutInflater)var1.getSystemService("layout_inflater"), this, true);
