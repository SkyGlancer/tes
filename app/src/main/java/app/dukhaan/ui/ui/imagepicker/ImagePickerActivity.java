...
import app.dukhaan.ui.imagepicker.ImagePickerActivity.1;
import app.dukhaan.ui.imagepicker.ImagePickerActivity.2;
...
public class ImagePickerActivity extends AppCompatActivity {
   ...
   private void handleUCropResult(Intent var1) {
      if (var1 == null) {
         ...
         this.setResultOk(UCrop.getOutput(var1));
      }
   }

   private static String queryName(ContentResolver var0, Uri var1) {
      Cursor var3 = var0.query(var1, (String[])null, (String)null, (String[])null, (String)null);
      int var2 = var3.getColumnIndex("_display_name");
      var3.moveToFirst();
      String var4 = var3.getString(R.string.var2);
      var3.close();
      return var4;
   }
   ...
   private void setResultOk(Uri var1) {
   ...
   public static void showImagePickerOptions(Context var0, app.dukhaan.ui.imagepicker.ImagePickerActivity.PickerOptionListener var1) {
      ...
      _$$Lambda$ImagePickerActivity$W12qNIZotYgpZo9Zk_904MEHJH0 var5 = new _$$Lambda$ImagePickerActivity$W12qNIZotYgpZo9Zk_904MEHJH0(var1);
         ...
         if (var1 != 1) {
            if (var1 != 69) {
               if (var1 != 96) {
                  ...
                  Throwable var6 = UCrop.getError(var3);
                  String var4 = TAG;
