...
public class PrimaryButtonShadowed extends FrameLayout {
   private BtnPrimaryShadowedBinding binding;
   private boolean enabled;
   private OnClickListener listener;
   private String text;

   public PrimaryButtonShadowed(Context var1) {
      super(var1);
      this.init(var1, (AttributeSet)null, 0);
   }

   public PrimaryButtonShadowed(Context var1, AttributeSet var2) {
      super(var1, var2);
      this.init(var1, var2, 0);
   }

   public PrimaryButtonShadowed(Context var1, AttributeSet var2, int var3) {
   ...
   private void applyStyle() {
      ...
      if (this.enabled) {
         this.binding.label.setTextColor(ContextCompat.getColor(R.color.this.getContext(), btn_primary_text_enabled));
         this.binding.label.setBackgroundResource(bg_btn_primary_enabled);
      } else {
         this.binding.label.setTextColor(ContextCompat.getColor(R.color.this.getContext(), btn_primary_text_disabled));
   ...
   private void init(Context var1, AttributeSet var2, int var3) {
      this.binding = BtnPrimaryShadowedBinding.inflate((LayoutInflater)var1.getSystemService("layout_inflater"), this, true);
