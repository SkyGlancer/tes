 ...
 *  app.dukhaan.ui.imagepicker.ImagePickerActivity$1
 *  app.dukhaan.ui.imagepicker.ImagePickerActivity$2
...
import app.dukhaan.ui.imagepicker.-$$Lambda$ImagePickerActivity$W12qNIZotYgpZo9Zk-904MEHJH0;
...
extends AppCompatActivity {
    ...
    static {
        TAG = ImagePickerActivity.class.getSimpleName();
    }

    static /* synthetic */ Uri access$000(ImagePickerActivity imagePickerActivity, String string2) {
        return imagePickerActivity.getCacheImagePath(string2);
    }
    ...
    private void cropImage(Uri uri) {
        Uri uri2 = Uri.fromFile((File)new File(this.getCacheDir(), ImagePickerActivity.queryName(this.getContentResolver(), uri)));
    ...
    private void handleUCropResult(Intent intent) {
        ...
        this.setResultOk(UCrop.getOutput(intent));
    }
    ...
    private void setResultOk(Uri uri) {
        ...
        intent.putExtra("path", (Parcelable)uri);
    ...
    public static void showImagePickerOptions(Context context, PickerOptionListener pickerOptionListener) {
        ...
        builder.setItems(arrcharSequence, (DialogInterface.OnClickListener)new -$$Lambda$ImagePickerActivity$W12qNIZotYgpZo9Zk-904MEHJH0(pickerOptionListener));
        builder.create().show();
    }
