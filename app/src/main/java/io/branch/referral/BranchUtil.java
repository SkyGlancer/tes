...
public class BranchUtil {
    private static Boolean isManifestTestModeEnabled;
    private static boolean isTestModeEnabled_;
     ...
     */
    static boolean checkTestMode(Context var0) {
    ...
    public static int dpToPx(Context context, int n) {
        ...
        return Math.round((float)((float)n * (displayMetrics.xdpi / 160.0f)));
    }

    static JSONObject formatLinkParam(JSONObject jSONObject) {
        return BranchUtil.addSource(jSONObject);
    }

    /*
     * Exception decompiling
     */
    public static JSONObject getDeepLinkSchemes(Context var0) {
        // This method has failed to decompile.  When submitting a bug report, please provide this stack trace, and (if you hold appropriate legal rights) the relevant class file.
        // org.benf.cfr.reader.util.ConfusedCFRException: Underrun type stack
        // org.benf.cfr.reader.b.a.c.e.a(StackSim.java:35)
        // org.benf.cfr.reader.b.b.af.a(OperationFactoryPop.java:20)
     ...
     * Exception decompiling
     */
    public static String readBranchKey(Context var0) {
        // This method has failed to decompile.  When submitting a bug report, please provide this stack trace, and (if you hold appropriate legal rights) the relevant class file.
        // org.benf.cfr.reader.util.ConfusedCFRException: Underrun type stack
        // org.benf.cfr.reader.b.a.c.e.a(StackSim.java:35)
        // org.benf.cfr.reader.b.b.af.a(OperationFactoryPop.java:20)
    ...
    static void setTestMode(boolean bl) {
        isTestModeEnabled_ = bl;
    }
