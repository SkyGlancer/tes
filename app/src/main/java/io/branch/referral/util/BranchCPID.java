...
public class BranchCPID {
    ...
    public JSONArray getPastCrossPlatformIds() {
        ...
        if (jSONObject != null && jSONObject.length() != 0) {
            try {
                JSONArray jSONArray = this.cpidData.getJSONObject(Defines.Jsonkey.UserData.getKey()).getJSONArray(key_past_cross_platform_id);
                return jSONArray;
            }
    ...
    public JSONArray getProbabilisticCrossPlatformIds() {
        // This method has failed to decompile.  When submitting a bug report, please provide this stack trace, and (if you hold appropriate legal rights) the relevant class file.
        // org.benf.cfr.reader.util.ConfusedCFRException: Invalid stack depths @ lbl47.1 : ACONST_NULL : trying to set 0 previously set to 1
        // org.benf.cfr.reader.b.a.a.g.a(Op02WithProcessedDataAndRefs.java:203)
        // org.benf.cfr.reader.b.a.a.g.a(Op02WithProcessedDataAndRefs.java:1489)
        // org.benf.cfr.reader.b.f.a(CodeAnalyser.java:308)
        // org.benf.cfr.reader.b.f.a(CodeAnalyser.java:182)
    ...
    public class ProbabilisticCPID {
        ...
        public ProbabilisticCPID(String string2, Double d) {
            this.id = string2;
            this.probability = d;
        }
