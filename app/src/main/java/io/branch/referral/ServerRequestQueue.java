...
class ServerRequestQueue {
    ...
    private ServerRequestQueue(Context context) {
        ...
        this.sharedPref = sharedPreferences = context.getSharedPreferences("BNC_Server_Request_Queue", 0);
    ...
    public static ServerRequestQueue getInstance(Context context) {
        ...
        Class<ServerRequestQueue> class_ = ServerRequestQueue.class;
    ...
    private void persist() {
        new Thread(new Runnable(){
            ...
            public void run() {
                ...
                Object object2 = object = reqQueueLockObject;
                // MONITORENTER : object2
                for (ServerRequest serverRequest : ServerRequestQueue.this.queue) {
                    JSONObject jSONObject;
                    if (!serverRequest.isPersistable() || (jSONObject = serverRequest.toJSON()) == null) continue;
                ...
                try {
                    ...
                    stringBuilder.append("Failed to persist queue");
                    if (string2 == null) {
                        string2 = "";
                    }
     ...
     */
    private List<ServerRequest> retrieve(Context var1) {
        // This method has failed to decompile.  When submitting a bug report, please provide this stack trace, and (if you hold appropriate legal rights) the relevant class file.
        // org.benf.cfr.reader.util.ConfusedCFRException: Invalid stack depths @ lbl49.3 : FAKE_TRY : trying to set 1 previously set to 0
    ...
    boolean containsClose() {
        ...
        synchronized (object2) {
            ...
            } while ((serverRequest = (ServerRequest)iterator.next()) == null || !serverRequest.getRequestPath().equals((Object)Defines.RequestPath.RegisterClose.getPath()));
            return true;
        }
    }
    ...
    boolean containsInitRequest() {
        ...
        synchronized (object2) {
            ...
            do {
                if (!iterator.hasNext()) return false;
            } while (!((ServerRequest)iterator.next() instanceof ServerRequestInitSession));
            return true;
        }
    }
    ...
    ServerRequest dequeue() {
        // This method has failed to decompile.  When submitting a bug report, please provide this stack trace, and (if you hold appropriate legal rights) the relevant class file.
        // org.benf.cfr.reader.util.ConfusedCFRException: Invalid stack depths @ lbl25 : ALOAD : trying to set 1 previously set to 0
        // org.benf.cfr.reader.b.a.a.g.a(Op02WithProcessedDataAndRefs.java:203)
        // org.benf.cfr.reader.b.a.a.g.a(Op02WithProcessedDataAndRefs.java:1489)
        // org.benf.cfr.reader.b.f.a(CodeAnalyser.java:308)
        // org.benf.cfr.reader.b.f.a(CodeAnalyser.java:182)
    ...
    void enqueue(ServerRequest serverRequest) {
        ...
        synchronized (object2) {
            if (serverRequest != null) {
                this.queue.add((Object)serverRequest);
                if (this.getSize() >= 25) {
                    this.queue.remove(1);
                }
                this.persist();
     ...
     * Exception decompiling
     */
    void insert(ServerRequest var1, int var2) {
        // This method has failed to decompile.  When submitting a bug report, please provide this stack trace, and (if you hold appropriate legal rights) the relevant class file.
     ...
     * Exception decompiling
     */
    public boolean remove(ServerRequest var1) {
        // This method has failed to decompile.  When submitting a bug report, please provide this stack trace, and (if you hold appropriate legal rights) the relevant class file.
        // org.benf.cfr.reader.util.ConfusedCFRException: Invalid stack depths @ lbl19.1 : ALOAD : trying to set 1 previously set to 0
        // org.benf.cfr.reader.b.a.a.g.a(Op02WithProcessedDataAndRefs.java:203)
        // org.benf.cfr.reader.b.a.a.g.a(Op02WithProcessedDataAndRefs.java:1489)
        // org.benf.cfr.reader.b.f.a(CodeAnalyser.java:308)
        // org.benf.cfr.reader.b.f.a(CodeAnalyser.java:182)
     ...
     * Exception decompiling
     */
    public ServerRequest removeAt(int var1) {
        // This method has failed to decompile.  When submitting a bug report, please provide this stack trace, and (if you hold appropriate legal rights) the relevant class file.
        // org.benf.cfr.reader.util.ConfusedCFRException: Invalid stack depths @ lbl25 : ALOAD : trying to set 1 previously set to 0
        // org.benf.cfr.reader.b.a.a.g.a(Op02WithProcessedDataAndRefs.java:203)
        // org.benf.cfr.reader.b.a.a.g.a(Op02WithProcessedDataAndRefs.java:1489)
